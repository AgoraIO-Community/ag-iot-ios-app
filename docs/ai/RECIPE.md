# iOS IoT video calling app

## Overview

Connect an iOS mobile client to an Agora IoT device for live audio/video calling and device interaction.

Use this recipe when you want a working reference for iOS app, Agora RTC, IoT device pairing, permissions.

Repository: [AgoraIO-Community/ag-iot-ios-app](https://github.com/AgoraIO-Community/ag-iot-ios-app)
...
```text
You are working in `AgoraIO-Community/ag-iot-ios-app`. Add or adapt this sample so a developer can run the ios iot video calling app end to end with Agora RTC.
